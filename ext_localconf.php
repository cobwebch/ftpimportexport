...
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['scheduler']['tasks'][\Cobweb\Ftpimportexport\Task\ImportExport::class] = array(
	'extension' => $_EXTKEY,
	...
	'additionalFields'	=> \Cobweb\Ftpimportexport\Task\ImportExportAdditionalFields::class
);
